...
b2 install -a toolset=%TOOLCHAIN% link=shared --layout=tagged runtime-link=shared threading=multi address-model=%CK_TARGET_CPU_BITS% --prefix=%BOOST_BUILD_PATH% %BOOST_B2_FLAGS% %BOOST_PYTHON% %BOOST_B2_EXTRA_FLAGS% --without-python
