...
b2 install -a address-model=%CK_TARGET_CPU_BITS% toolset=%TOOLCHAIN% link=static runtime-link=static define=BOOST_TEST_ALTERNATIVE_INIT_API threading=multi --layout=tagged --with-program_options --with-test --prefix=%BOOST_BUILD_PATH%
